...
namespace Indigox.UUM.Application.Sync.WebServices.AD
{
    ...
    public class ADImportOrganizationalRoleService : IImportOrganizationalRoleService
    {
        ...
        public string SyncOrganizationalRole(string nativeID, string organizationalUnitID, string name, string fullName, string displayName, string email, string description, double orderNum, PropertyChangeCollection extendProperties)
        {
            ...
            return this.Create(nativeID, organizationalUnitID, name, fullName, displayName, email, description, orderNum, extendProperties);
        }
