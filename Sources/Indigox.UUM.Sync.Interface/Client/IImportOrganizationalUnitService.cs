...
{
    [WebServiceBinding( Name = "ImportOrganizationalUnitService", Namespace = Consts.Namespace, ConformsTo = WsiProfiles.BasicProfile1_1 )]
    public interface IImportOrganizationalUnitService
    {
        ...
        string SyncOrganizationalUnit(string nativeID, string parentOrganizationalUnitID, string name, string fullName, string displayName, string email, string description, double orderNum, string organizationalUnitType, PropertyChangeCollection extendProperties);
        ...
        string Create(string nativeID, string parentOrganizationalUnitID, string name, string fullName, string displayName, string email, string description, double orderNum, string organizationalUnitType, PropertyChangeCollection extendProperties);
        ...
        void ChangeProperty( string organizationalUnitID, PropertyChangeCollection propertyChanges );
