...
{
    [WebServiceBinding(Name = "ImportHROrganizationalRoleService", Namespace = Consts.Namespace_HR+"organizationalrole/", ConformsTo = WsiProfiles.BasicProfile1_1)]
    public interface IImportHROrganizationalRoleService
    {
        ...
        string SyncOrganizationalRole(string nativeID, string organizationalUnitID, string name, string fullName, string displayName, string email, string description, double orderNum, HRPropertyChangeCollection extendProperties);
        ...
        string Create(string nativeID, string organizationalUnitID, string name, string fullName, string displayName, string email, string description, double orderNum, HRPropertyChangeCollection extendProperties);
        ...
        void ChangeProperty(string organizationalRoleID, HRPropertyChangeCollection propertyChanges);
