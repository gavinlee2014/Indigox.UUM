...
{
    internal class UserAddedToOrganizationalUnitEventTaskBuilder : AbstractPrincipalEventTaskBuilder
    {
        protected override ISyncContext BuildSyncContext()
        {
            ISyncContext context = base.BuildSyncContext();

            UserAddedToOrganizationalUnitEvent concreateEvent = (UserAddedToOrganizationalUnitEvent)this.Event;
