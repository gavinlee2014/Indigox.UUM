...
{
    internal class OrganizationalRoleAddedToGroupEventTaskBuilder : AbstractPrincipalEventTaskBuilder
    {
        protected override ISyncContext BuildSyncContext()
        {
            ISyncContext context = base.BuildSyncContext();

            OrganizationalRoleAddedToGroupEvent concreateEvent = (OrganizationalRoleAddedToGroupEvent)this.Event;
