...
{
    internal class OrganizationalRoleRemovedFromGroupEventTaskBuilder : AbstractPrincipalEventTaskBuilder
    {
        protected override ISyncContext BuildSyncContext()
        {
            ISyncContext context = base.BuildSyncContext();

            OrganizationalRoleRemovedFromGroupEvent concreateEvent = (OrganizationalRoleRemovedFromGroupEvent)this.Event;
