...
{
    internal class OrganizationalUnitRemovedFromOrganizationalUnitEventTaskBuilder : AbstractPrincipalEventTaskBuilder
    {
        protected override ISyncContext BuildSyncContext()
        {
            ISyncContext context = base.BuildSyncContext();

            OrganizationalUnitRemovedFromOrganizationalUnitEvent concreateEvent = (OrganizationalUnitRemovedFromOrganizationalUnitEvent)this.Event;
