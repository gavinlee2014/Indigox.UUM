...
{
    internal class OrganizationalRoleRemovedFromRoleEventTaskBuilder : AbstractPrincipalEventTaskBuilder
    {
        protected override ISyncContext BuildSyncContext()
        {
            ISyncContext context = base.BuildSyncContext();

            OrganizationalRoleRemovedFromRoleEvent concreateEvent = (OrganizationalRoleRemovedFromRoleEvent)this.Event;
