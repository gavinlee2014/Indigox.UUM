...
{
    internal class GroupPropertyChangedEventTaskBuilder : AbstractPrincipalEventTaskBuilder
    {
        protected override ISyncContext BuildSyncContext()
        {
            ISyncContext context = base.BuildSyncContext();

            GroupPropertyChangedEvent concreateEvent = (GroupPropertyChangedEvent)this.Event;
