...
{
    internal class OrganizationalUnitRemovedFromGroupEventTaskBuilder : AbstractPrincipalEventTaskBuilder
    {
        protected override ISyncContext BuildSyncContext()
        {
            ISyncContext context = base.BuildSyncContext();

            OrganizationalUnitRemovedFromGroupEvent concreateEvent = (OrganizationalUnitRemovedFromGroupEvent)this.Event;
            context.Set( "GroupID", concreateEvent.Group.ID );
        ...
        protected override ISyncExecutor BuildSyncExecutor()
        {
            ...
            executor.Method = "RemoveOrganizationalUnit";
